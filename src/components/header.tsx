      ...
      <div className='flex items-start justify-between gap-2'>
        ...
        <div className='pointer-events-auto flex items-center gap-2'>
          <Button
            ...
            aria-label={activeRightPanel === 'settings' ? 'Close settings sidebar' : 'Open settings sidebar'}
          ...
          <Button
            ...
            aria-label={activeRightPanel === 'verifier' ? 'Close verifier sidebar' : 'Open verifier sidebar'}
